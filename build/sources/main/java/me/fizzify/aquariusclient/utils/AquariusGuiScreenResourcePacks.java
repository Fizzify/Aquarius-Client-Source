...
import me.fizzify.aquariusclient.mixins.client.resources.IMixinResourcePackListEntry;
...
public class AquariusGuiScreenResourcePacks {

    private GuiScreenResourcePacks parent;

    public AquariusGuiScreenResourcePacks(GuiScreenResourcePacks parent) {
        this.parent = parent;
    }
    ...
    public GuiResourcePackAvailable updateList(CustomGuiTextField searchField, GuiResourcePackAvailable availablePacksClone,
